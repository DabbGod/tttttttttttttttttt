...
for i, vvv in pairs(game.Players:GetChildren()) do
local detect1 = ("report")
local detect2 = ("REPORT")
local detect3 = ("bot")
vvv.Chatted:Connect(function(msg)
if string.find(string.lower(msg), string.lower(detect1)) or if string.find(string.lower(msg), string.lower(detect2)) or if string.find(string.lower(msg), string.lower(detect3)) then
